                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select wire:model.defer="inventories.{{$index}}.coil_id" class="form-control">
                                                            <option value="">اختر المقاومه</option>
                                                            @foreach($device->coilsOhms as $coilsOhm)
                                                                <option value="{{ $coilsOhm->id }}">{{$coilsOhm->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    @endif
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="badge badge-info">{{ $inventory->coil->resistance }}</span>
