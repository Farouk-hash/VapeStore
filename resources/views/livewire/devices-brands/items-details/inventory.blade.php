                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select wire:model.defer="inventories.{{$index}}.device_color_id" class="form-control">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select wire:model.defer="inventories.{{$index}}.device_flavor_id" class="form-control">
                                                            <option value="">اختر النكهة</option>
                                                            @foreach($device->flavors as $flavorComponent)
                                                                <option value="{{ $flavorComponent->id }}">{{ $flavorComponent->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    @endif
