				...
				<div class="card">
					...
					<div class="card-header pb-0">
						<div class="d-flex justify-content-between">
							...
							class="btn btn-primary" role="button" aria-pressed="true">New Component</a>
					...
					<div class="card-header pb-0">
						<div class="d-flex justify-content-between">
							<h4 class="card-title mg-b-0">Components</h4>
								...
								<tbody>
									@foreach ($components as $component )
										<tr>
											...
											<td>{{$component->categoryAssoicated['name']}}</td>
											<td>{{$component->created_at}}</td>
											<td>{{$component->updated_at}}</td>
											<td>
												<div class="dropdown">
													<button class="btn btn-sm btn-primary dropdown-toggle" type="button" id="dropdownMenuButton{{ $component->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
														Actions
													</button>
													<div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $component->id }}">
											...
											@include('dashboard.vape-components.edit')
										</tr>
									@endforeach
