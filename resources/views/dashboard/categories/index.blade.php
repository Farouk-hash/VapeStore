				...
				<div class="card">
					...
					<div class="card-header pb-0">
						<div class="d-flex justify-content-between">
							...
							class="btn btn-primary" role="button" aria-pressed="true">New Category</a>
							...
							<table class="table text-md-nowrap" id="example1">
								<thead>
									<tr>
										...
										<th class="wd-10p border-bottom-0">Components</th>
								...
								<tbody>
									@foreach ($categories as $category )
										<tr>
											...
											<td>
												<div class="dropdown">
													<button class="btn btn-sm btn-primary dropdown-toggle" type="button" id="dropdownMenuButton{{ $category->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
														Actions
													</button>
