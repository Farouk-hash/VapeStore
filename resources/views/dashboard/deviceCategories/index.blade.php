...
<div class="breadcrumb-header justify-content-between">
    <h4 class="content-title mb-0">إدارة ماركات الأجهزة</h4>
</div>
<!-- breadcrumb -->
@endsection
        ...
        <div class="card">
            ...
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <a 
                    {{-- href="{{ route('device-brands.create') }}"  --}}
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $brand->id }}">
                                                <a class="dropdown-item modal-effect text-primary" 
                                                   {{-- href="{{ route('device-brands.edit', $brand->id) }}" --}}
                                                   >
                                                    <i class="las la-pen"></i> تعديل
                                                </a>

                                                <form 
                                                {{-- action="{{ route('device-brands.destroy', $brand->id) }}"  --}}
                                                ...
                                                <a class="dropdown-item modal-effect text-info" 
                                                   href="{{ route('devicesCategories.show', [$categorySlug,$brand->id]) }}"
                                                   >
