...
@section('page-header')
		...
		<div class="breadcrumb-header justify-content-between">
			<div class="my-auto">
				<div class="d-flex">
					<h4 class="content-title mb-0 my-auto">الصفحه الشخصيه</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
				</div>
			</div>
                                ...
                                <div class="main-profile-overview">
                                    ...
                                    @if($guard !== 'admin')
                                        <div class="d-flex justify-content-between mg-b-20">
                                            <div>
                                                <span class=" pulse{{$attributes['account_active'] == 1 ? "" : "-danger"}}"></span>
                                                <h5 class="main-profile-name">{{$attributes['name']}}</h5>
                                                <p class="main-profile-name-text" style='color: {{$attributes['account_active'] == 1 ? "green" : "red"}};'>
                                                    {{$attributes['account_active'] == 0 ? 'غير مفعل':'مفعل'}}
                                                </p>
                                        ...
                                        <div class="main-profile-bio">
                                            {{$attributes['bioData'] ?? 'لا يوجد ملف تعريفي'}}
                                ...
                                <div class="card-body">
                                    <div class="counter-status d-flex md-mb-0">
                                        ...
                                        <div class="mr-auto">
                                            ...
                                            <h2 class="mb-0 tx-22 mb-1 mt-1">{{$attributes['bills']->count()}}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                                ...
                                <div class="tab-pane active" id="home">
                                    ...
                                    @if($guard !== 'admin')
                                        ...
                                        <div class="m-t-30">
                                            @forelse ($attributes['history'] as $historyDetails)
                                                <div class=" p-t-10">
                                ...
                                <div class="tab-pane active" id="employeeActions">
                                    <div class="row">
                                        @foreach ($attributes['bills'] as $bill )
                                            <div class="col-sm-4">
                                ...
                                <div class="tab-pane" id="settings">
                                    ...
                                    <form action="#" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{$attributes['name']}}" id="name" name='name' class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">الايميل</label>
                                            <input type="email" value="{{$attributes['email']}}" id="email" name='email' class="form-control">
                                        </div>
                                        @if($guard !=='admin')
                                            <div class="form-group">
                                                <label for="nationalID">الرقم القومي</label>
                                                <input type="text" value="{{$attributes['nationalID']}}" id="nationalID" name='nationalID' class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="phone">رقم الهاتف</label>
                                                <input type="string" value="{{$attributes['phone']}}" id="phone" name='phone' class="form-control">
                                            </div>
