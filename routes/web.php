...
Route::prefix('dashboard')->middleware(['auth:admin,sales'])->group(function(){
    ...
    Route::get('itemsDetails/{itemID}/{forceDetails?}',
    fn($itemID,$forceDetails=null)=>view('livewire.liquids-brands.items-details.main', ['itemID'=>$itemID,'forceDetails'=>$forceDetails]))->name('livewire.details');
    
    Route::get('devicesLivewire',fn()=>view('livewire.devices-brands.main',))->name('livewire.devices');
    Route::get('devicesItemsDetails/{itemID}/{slug?}/{forceDetails?}',fn($itemID , $slug=null , $forceDetails=null)=>view('livewire.devices-brands.items-details.main',['itemID'=>$itemID , 'slug'=>$slug , 'forceDetails'=>$forceDetails]))->name('livewire.devices.itemsDetails');
